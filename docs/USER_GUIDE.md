...
JapanLearning 不是一套完整课程，也不是教材内容仓库。它提供的是一套学习系统骨架：
...
如果你要处理音频或视频，推荐把 ListenKit 放在 JapanLearning 旁边：
...
ListenKit 负责通用音视频转写。JapanLearning 负责把转写结果变成学习笔记和复习材料。
